...
rem javac GenTests.java || goto CompGenError
echo Generating tests...
rem java -ea GenTests || goto GenError
python gen.py
cd ..
...
for %%i in (tests\??) do (
    ...
    if EXIST %problem%_%author%.class (call run java -Xmx256M -Xss64M -ea %problem%_%author% || goto SourceRunningError)
